...
if curl -s http://169.254.169.254 > /dev/null ; then
...
s3fs -o iam_role="$IAM_ROLE" -o url="https://s3.eu-west-2.amazonaws.com" -o endpoint=eu-west-2 -o dbglevel=info -o curldbg -o use_cache=/tmp -o allow_other $FTP_BUCKET /home/aws/s3bucket
/usr/local/users.sh